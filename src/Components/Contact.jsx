...
const Contact = () => {
  ...
  return (
                        ...
                        {currentPages.map((contact) => {
                          ...
                          return (
                            <>
                              ...
                              <div className="flex flex-wrap justify-between items-center hover:bg-[#F2F7FF] p-1 cursor-pointer" onClick={e => handlerClick(e, name, email)}>
    ...
    <div className=" flex flex-wrap justify-center relative z-40">
          <div className=" w-1/2">
          {openModal && <ModalBth openModal={openModal} setOpenModal={setOpenModal} />}
          </div>
      </div>
    </>
